...
function Newclass() {
  ...
  const handleSaveChanges = () => {
    ...
    showMessage('success', 'Class created! You can create another');
  };
  ...
  return (
    <>
      <div className='bg-gray-100 w-full min-h-screen pt-28 pl-5 pr-5 md:pl-64 relative'>
        ...
        <div className='flex mb-5 items-center'>
          ...
          <h1 className='p-0 m-0 font-extrabold sm:text-lg xl:text-xl tracking-tight text-gray-800'>New class</h1>
        </div>
        <div className='flex flex-col items-center'>
          ...
          <div className='flex transition-all  justify-center p-10 md:pl-16 md:pr-16 w-full sm:w-full lg:w-2/5 bg-white pt-0 pb-10 rounded-b-md'>
            <button className={`rounded-sm flex justify-center items-center w-36 h-10 lg:w-44 lg:h-11 text-xs text-white ${classDetails.batch == '' || classDetails.prefix_register_number == '' || classDetails.regulation == '' || classDetails.batch == '' || classDetails.semester == '' || loading == true ? 'bg-blue-300 cursor-not-allowed' : ' bg-blue-500 cursor-pointer'}`} onClick={() => handleAddClassForm()}>
